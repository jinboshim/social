...
//	private static int boundPlusCount = 10;
	...
	@Scheduled(initialDelay = 3000, fixedDelay=60000) // 1min delay
	public void doTask() {
		System.out.println("@@@@@@@@@@@@@ BeautyCreator3 doTask start @@@@@@@@@@@@@");
		EData scheduleInfo = new EData();
		scheduleInfo.put("id", "creatorCategoryBatchVN3");
		try {
