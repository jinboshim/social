package social.network.uptempo.batch.tiktok.vn;
...
//@RestController
//@Component
public class CategoryBatchTask {
	...
	private String cookie = "sessionid=edcbc530ea4f54528fafca54c1c97be1"; 
//	private String cookie = "sessionid_tiktokseller="; 
	
	public CategoryBatchTask() {
...
//	@Scheduled(cron = "0 0 2 * * *", zone = "Asia/Seoul")
	@Scheduled(initialDelay = 3000, fixedDelay=30000) // 5min delay
	public void doTask() {
