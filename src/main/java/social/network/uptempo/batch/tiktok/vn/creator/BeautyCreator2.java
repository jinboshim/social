...
//	private static int boundPlusCount = 10;
	...
	@Scheduled(initialDelay = 2000, fixedDelay=60000) // 1min delay
	public void doTask() {
		System.out.println("@@@@@@@@@@@@@ BeautyCreator2 doTask start @@@@@@@@@@@@@");
		EData scheduleInfo = new EData();
		scheduleInfo.put("id", "creatorCategoryBatchVN2");
		try {
