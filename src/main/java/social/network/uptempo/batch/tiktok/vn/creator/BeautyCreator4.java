...
//	private static int boundPlusCount = 10;
	...
	@Scheduled(initialDelay = 4000, fixedDelay=60000) // 1min delay
	public void doTask() {
		System.out.println("@@@@@@@@@@@@@ BeautyCreator4 doTask start @@@@@@@@@@@@@");
		EData scheduleInfo = new EData();
		scheduleInfo.put("id", "creatorCategoryBatchVN4");
		try {
