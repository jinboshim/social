...
//@Component
public class CreatorCategoryBatchTask {
	...
	public CreatorCategoryBatchTask() {
...
//		DefaultTransactionDefinition def = new DefaultTransactionDefinition();
	...
	@Scheduled(initialDelay = 5000, fixedDelay=30000) // 5min delay
	public void doTask() {
		EData scheduleInfo = new EData();
		scheduleInfo.put("id", "creatorCategoryBatch");
		try {
			...
			if( eData.compareString("START_YN", "Y") ) {
				...
				List<EData> categoryList = codeMapper.tiktokCategoryList(eData);
