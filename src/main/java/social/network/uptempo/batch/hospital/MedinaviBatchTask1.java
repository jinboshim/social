...
@Service
public class MedinaviBatchTask1 {
...
//	String url = "http://medinavi.co.kr/medical_course/{region}_{gubun}_{startIndex}.html";
	...
	public void doTask() throws Exception {
		...
		System.out.println("@@@@@@@@@@@ MedinaviBatchTask1 call @@@@@@@@@@");
		
		if(!is_run) {
			is_run = true;
			System.out.println("@@@@@@@@@@@ MedinaviBatchTask1 start @@@@@@@@@@");
				...
				for(int i=0,j=gubuns.length; i<j; i++) {
					try {
						...
						while(loopStatus) {
							...
							System.out.println("@@@@@@@@@@@ targetUrl1 : " + targetUrl);
