...
@Service
public class MedinaviBatchTask4 {
...
//	String url = "http://medinavi.co.kr/medical_course/{region}_{gubun}_{startIndex}.html";
	...
	public void doTask() throws Exception {
		...
		String[] regions = HospitalConstants.MEDI_REGIONS_4;
		String[] gubuns = HospitalConstants.MEDI_GUBUN;
		System.out.println("@@@@@@@@@@@ MedinaviBatchTask4 call @@@@@@@@@@");
		
		if(!is_run) {
			is_run = true;
			System.out.println("@@@@@@@@@@@ MedinaviBatchTask4 start @@@@@@@@@@");
				...
				for(int i=0,j=gubuns.length; i<j; i++) {
					try {
						...
						while(loopStatus) {
							...
							System.out.println("@@@@@@@@@@@ targetUrl4 : " + targetUrl);
