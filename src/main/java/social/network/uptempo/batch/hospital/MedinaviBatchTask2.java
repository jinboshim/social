...
@Service
public class MedinaviBatchTask2 {
...
//	String url = "http://medinavi.co.kr/medical_course/{region}_{gubun}_{startIndex}.html";
	...
	public void doTask() throws Exception {
		...
		String[] regions = HospitalConstants.MEDI_REGIONS_2;
		String[] gubuns = HospitalConstants.MEDI_GUBUN;
		System.out.println("@@@@@@@@@@@ MedinaviBatchTask2 call @@@@@@@@@@");
		
		if(!is_run) {
			is_run = true;
			System.out.println("@@@@@@@@@@@ MedinaviBatchTask2 start @@@@@@@@@@");
				...
				for(int i=0,j=gubuns.length; i<j; i++) {
					try {
						...
						while(loopStatus) {
							...
							System.out.println("@@@@@@@@@@@ targetUrl2 : " + targetUrl);
